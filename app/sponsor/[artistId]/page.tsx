...
export default function SponsorPage({ params }: Props) {
  ...
  const compatibleMaterials = materials.filter((m) =>
    m.compatibleGenres.includes(artist.genre) && !m.isFunded
  );
    ...
    return (
      <div className="min-h-screen bg-paper">
        ...
        <div className="max-w-lg mx-auto px-5 py-20 text-center">
          <div className="w-16 h-16 bg-[--sv] rounded-full flex items-center justify-center mx-auto mb-6 text-2xl">
            ✉️
          </div>
          ...
          <div className="bg-[--navy-800] text-white rounded-xl p-5 mb-6 text-center">
            <p className="text-[--sv] text-xs font-bold tracking-widest mb-2 uppercase">씨앗 배지 획득</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/"
              className="flex-1 bg-white border border-navy-200 text-[--navy-700] font-semibold py-3.5 rounded-lg hover:bg-navy-100 transition-colors text-sm text-center"
            >
              다른 작가 보기
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-paper">
      ...
      <div className="max-w-[640px] mx-auto px-5 md:px-8 py-10">
        ...
        <div className="bg-[--navy-800] rounded-xl p-5 flex items-center gap-4 mb-8">
          ...
          <div>
            <p className="text-[--sv] text-xs font-bold tracking-widest uppercase mb-1">재료 선물하기</p>
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <span className="w-6 h-6 rounded-full bg-[--sv] text-[--ink] text-xs font-black flex items-center justify-center">
              1
            </span>
              ...
              compatibleMaterials.map((m) => (
                <button
                  ...
                  className={`w-full flex items-start gap-4 p-4 rounded-xl border-2 text-left transition-all duration-150 ${
                    selected === m.id
                      ? "border-[--navy-800] bg-white shadow-card"
        ...
        <section className="mb-8">
          ...
          <textarea
            ...
            maxLength={500}
            rows={4}
            className="w-full bg-white border-2 border-navy-100 focus:border-[--navy-700] rounded-xl p-4 text-sm text-[--ink] placeholder-[--muted] resize-none outline-none transition-colors leading-relaxed"
          />
        ...
        {selectedMaterial && (
          <div className="bg-white border border-navy-100 rounded-xl p-5 mb-4 shadow-card">
        ...
        <button
          ...
          className={`w-full py-4 rounded-xl font-bold text-base transition-all ${
            selected
              ? "bg-[--navy-800] text-white hover:bg-[--navy-700] shadow-card"
